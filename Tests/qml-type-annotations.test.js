...
function testBarTabMonitorAliasesAreTyped() {
  ...
  assert.match(source, monitorDelegate, "BarTab monitor delegate must expose typed aliases for ShellScreen fields");
...
function testNotificationsTabMonitorAliasesAreTyped() {
  ...
  assert.match(source, monitorDelegate, "NotificationsTab monitor delegate must expose typed aliases for ShellScreen fields");
