...
- [x] Monitor directory, wallpaper, and wallpaper-list lookups use typed string screen-name inputs.
...
- [x] Internal wallpaper updates type the resolved screen name and path inputs.
