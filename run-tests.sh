...
Commands:
  ...
  probes         Run read-only service probes for notifications, audio, brightness, battery, clipboard, wallpaper/colors, settings, state cache, network state, and power profile.
