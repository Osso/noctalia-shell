...
Commands:
  ...
  probes         Run read-only service probes for notifications, audio, brightness, battery, Bluetooth, clipboard, wallpaper/colors, settings, state cache, network state, and power profile.
