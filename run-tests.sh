...
Commands:
  ...
  probes         Run read-only service probes for notifications, audio, brightness, battery, Bluetooth, clipboard, VPN, screen recorder, program checks, system stats, wallpaper/colors, settings, state cache, network state, and power profile.
