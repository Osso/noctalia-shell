...
Commands:
  ...
  probes         Run read-only service probes for notifications, audio, brightness, battery, Bluetooth, clipboard, VPN, screen recorder, program checks, system stats, host/fonts, wallpaper/colors, settings, state cache, network state, and power profile.
